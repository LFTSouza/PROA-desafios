# Hora de codar 4
Uma série de desafios propostos pelo instituto PROA. O primeiro desafio está no repositório com o nome de "Cadastro de estudantes".

1 )
Crie um programa onde o usuário possa cadastrar estudantes sem limites, e, em seguida, Se o usuário digitar "PARE" o programa deve exibir a quantidade de estudantes cadastrados e a lista com cada um deles. (Cadatro de estudantes);
